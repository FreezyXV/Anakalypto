---
type: article
title: La consommation mondiale de pétrole et de gaz
slug: consommation-mondiale-petrole-gaz
categoryPath: energie/energies-fossiles-et-nucleaire/hydrocarbures
summary: >
  La demande mondiale de pétrole a atteint environ 103,5 millions de barils par jour en 2024,
  et sa part dans la demande énergétique totale est passée pour la première fois sous 30 %,
  selon l'Agence internationale de l'énergie.
tags: [energie, petrole, gaz, IEA, hydrocarbures]
relatedArticles: [energies-renouvelables-panorama]
sources:
  - title: "Oil - Global Energy Review 2025"
    url: "https://www.iea.org/reports/global-energy-review-2025/oil"
    publisher: "Agence internationale de l'énergie (IEA)"
    date: "2025"
  - title: "Oil - Global Energy Review 2026"
    url: "https://www.iea.org/reports/global-energy-review-2026/oil"
    publisher: "Agence internationale de l'énergie (IEA)"
    date: "2026"
...
Selon l'Agence internationale de l'énergie (IEA), la demande mondiale de pétrole a atteint
environ 103,5 millions de barils par jour en 2024. Sa croissance ralentit nettement : après
une hausse de 830 000 barils par jour (environ 0,8 %) en 2024, marquant la fin du fort
rebond post-pandémie de COVID-19, l'IEA prévoit une progression plus modeste d'environ
650 000 barils par jour (environ 0,7 %) en 2025.

## Un cap symbolique franchi en 2024

Pour la première fois de son histoire, la part du pétrole dans la demande énergétique
mondiale totale est passée sous la barre des 30 % en 2024, alors qu'elle culminait à environ
46 % à son pic historique. Ce recul relatif s'explique par plusieurs facteurs convergents :
le ralentissement de la croissance industrielle dans certaines grandes économies, l'essor
rapide du véhicule électrique, qui réduit la demande de carburants pour le transport routier,
et la montée en puissance continue des énergies renouvelables dans le mix énergétique
mondial.

## La pétrochimie, nouveau moteur de la demande

Face au ralentissement de la demande liée au transport, la pétrochimie — c'est-à-dire la
transformation du pétrole en plastiques et autres produits chimiques de base — devient
progressivement le principal moteur de la croissance de la demande pétrolière mondiale,
selon l'IEA. Du côté de l'offre, celle-ci a augmenté d'environ 3 millions de barils par jour
en 2025, portée notamment par le retour progressif de la production des pays de l'OPEP+ et
par la croissance continue de la production sur le continent américain.

## Des prix en baisse

Conséquence de cette combinaison entre une demande en ralentissement et une offre abondante,
les prix du pétrole ont reculé d'environ 15 % en moyenne en 2025 par rapport à 2024, selon
les données de l'IEA, une évolution qui pèse directement sur les recettes des pays
producteurs tout en allégeant la facture énergétique des pays importateurs.

## Faits clés

- Demande mondiale de pétrole en 2024 : environ 103,5 millions de barils par jour (IEA).
- Croissance de la demande : +0,8 % en 2024, prévision de +0,7 % en 2025.
- La part du pétrole dans la demande énergétique mondiale est passée sous 30 % en 2024 (pic
  historique : 46 %).
- Prix du pétrole en baisse d'environ 15 % en moyenne en 2025 par rapport à 2024.

## Points de vigilance

Les niveaux de demande et de prix pour 2025-2026, ainsi que le plateau de demande pétrolière
mondiale anticipé par l'IEA autour de 105,5 millions de barils par jour en fin de décennie,
constituent des projections susceptibles d'évoluer selon le contexte géopolitique et
économique mondial ; ces chiffres doivent être présentés au conditionnel.

[Emplacement image : plateforme pétrolière ou raffinerie, légende et texte alternatif à
...
---
type: article
title: Les réseaux électriques intelligents (smart grids)
slug: reseaux-electriques-intelligents-smart-grids
categoryPath: energie/reseaux-et-stockage/reseaux-electriques
summary: >
  L'intégration croissante des énergies renouvelables nécessite une modernisation majeure des
  réseaux électriques ; l'IEA estime que les investissements dans les réseaux doivent
  presque doubler d'ici 2030 pour dépasser 600 milliards de dollars par an.
tags: [energie, smart-grid, reseaux-electriques, IEA, renouvelables]
relatedArticles: [energies-renouvelables-panorama]
sources:
  - title: "Electricity Grids and Secure Energy Transitions - Executive summary"
...
Un réseau électrique intelligent, ou smart grid, intègre des technologies de l'information et
de la communication ainsi que de nombreux capteurs au sein du réseau de distribution
électrique traditionnel, afin d'équilibrer en temps réel l'offre et la demande d'électricité,
de faciliter l'intégration de sources renouvelables intermittentes comme le solaire et
l'éolien, et de gérer une production de plus en plus décentralisée, notamment via les
panneaux solaires installés chez les particuliers.

## Les composants d'un réseau intelligent

Un réseau électrique intelligent s'appuie sur plusieurs briques technologiques : les
compteurs communicants, comme le compteur Linky déployé en France, qui transmettent en temps
quasi réel les données de consommation ; l'automatisation des postes de transformation et de
distribution, qui permet de détecter et d'isoler automatiquement certaines pannes ;
l'effacement de consommation, ou demand response, qui incite certains consommateurs à
réduire ponctuellement leur consommation en période de tension sur le réseau ; et le
déploiement croissant de batteries de stockage à différentes échelles, du particulier au
réseau tout entier.

## Un besoin d'investissement massif selon l'IEA

Dans un rapport publié le 17 octobre 2023, l'Agence internationale de l'énergie souligne que
l'investissement mondial dans les réseaux électriques doit presque doubler d'ici 2030 pour
dépasser 600 milliards de dollars par an, afin d'accompagner correctement la transition
énergétique en cours. L'IEA estime par ailleurs qu'il sera nécessaire d'ajouter ou de
remplacer environ 80 millions de kilomètres de lignes électriques d'ici 2040, soit
l'équivalent de la totalité du réseau électrique mondial actuellement en service.

## Un goulot d'étranglement pour les énergies renouvelables

L'insuffisance des réseaux électriques constitue déjà, selon l'IEA, un frein concret au
déploiement des énergies renouvelables : au moment de la publication du rapport, au moins
3 000 gigawatts de projets d'énergies renouvelables se trouvaient en file d'attente,
attendant un raccordement au réseau électrique, illustrant l'écart croissant entre la
capacité de production disponible et celle des infrastructures nécessaires pour
l'acheminer effectivement jusqu'aux consommateurs.

## Faits clés

- L'investissement mondial dans les réseaux électriques doit presque doubler d'ici 2030,
  pour dépasser 600 milliards de dollars par an (IEA).
- Environ 80 millions de km de lignes électriques à ajouter ou remplacer d'ici 2040.
- Au moins 3 000 GW de projets renouvelables en attente de raccordement au réseau.
- Technologies clés des smart grids : compteurs communicants, automatisation, effacement de
  consommation, stockage par batteries.

## À retenir

L'IEA qualifie explicitement les réseaux électriques de « maillon faible » potentiel des
transitions énergétiques propres si l'ambition et l'attention politiques qui leur sont
consacrées ne s'intensifient pas rapidement, un constat qui contraste avec l'attention
généralement plus forte portée aux capacités de production renouvelable elles-mêmes.

[Emplacement image : poste électrique moderne avec capteurs de supervision, légende et
...
---
type: article
title: Les services écosystémiques rendus par la biodiversité
slug: services-ecosystemiques-biodiversite
categoryPath: environnement-et-climat/biodiversite/ecosystemes
summary: >
  Selon l'évaluation mondiale de l'IPBES, environ un million d'espèces animales et végétales
  sont aujourd'hui menacées d'extinction, alors que les écosystèmes rendent des services
  vitaux dont la valeur économique reste largement sous-estimée dans les décisions publiques.
tags: [environnement, biodiversite, ecosystemes, IPBES, services-ecosystemiques]
relatedArticles: [liste-rouge-uicn-2025-biodiversite]
sources:
  - title: "Global Assessment Report on Biodiversity and Ecosystem Services"
    url: "https://www.ipbes.net/global-assessment"
    publisher: "IPBES"
    date: "2019"
  - title: "IPBES Values Assessment - Media Release"
    url: "https://www.ipbes.net/media_release/Values_Assessment_Published"
    publisher: "IPBES"
    date: "2022"
lastVerified: 2026-09-21
status: published
...
interactions entre eux et avec leur environnement physique. Ces écosystèmes rendent à
l'humanité des services essentiels, dits services écosystémiques, qui se répartissent en
quatre grandes catégories : les services d'approvisionnement (nourriture, eau, matières
premières), de régulation (climat, qualité de l'air, pollinisation), culturels (loisirs,
valeurs spirituelles) et de soutien (formation des sols, cycles biogéochimiques).

## Une érosion documentée de la biodiversité

L'évaluation mondiale de 2019 de la Plateforme intergouvernementale sur la biodiversité et
les services écosystémiques (IPBES), un rapport d'environ 1 148 pages, estime qu'environ un
million d'espèces animales et végétales sont aujourd'hui menacées d'extinction, un rythme
sans précédent dans l'histoire de l'humanité. Le même rapport souligne qu'environ 60 milliards
de tonnes de ressources renouvelables et non renouvelables sont désormais extraites chaque
année, soit le double du niveau enregistré en 1980, et que 23 % de la surface terrestre
présente une productivité biologique dégradée.

## Une intensification de l'exploitation des écosystèmes

Cette évaluation documente par ailleurs une intensification marquée de l'exploitation des
écosystèmes : la valeur des cultures agricoles produites dans le monde a augmenté de 300 %
depuis 1970, tandis que la récolte de bois brut a progressé de 45 % sur la même période,
illustrant la pression croissante exercée par les activités humaines sur les milieux
naturels, en parallèle de la croissance démographique et économique mondiale.

## Le débat sur la valeur de la nature

Une évaluation complémentaire de l'IPBES, consacrée spécifiquement aux « valeurs » de la
nature et publiée en 2022, critique le fait que les décisions politiques et économiques
s'appuient très majoritairement sur des valeurs strictement marchandes de la nature :
moins de 5 % des études de valorisation économique de la nature examinées auraient
réellement influencé des décisions politiques concrètes, ce qui suggère, selon l'IPBES, une
sous-exploitation persistante des multiples autres façons de reconnaître la valeur des
écosystèmes — culturelle, spirituelle, ou liée simplement au bien-être humain.

## Faits clés

- Environ 1 million d'espèces animales et végétales menacées d'extinction (IPBES, évaluation
  mondiale 2019).
- La valeur des cultures agricoles mondiales a augmenté de 300 % depuis 1970.
- Environ 60 milliards de tonnes de ressources extraites chaque année, soit le double du
  niveau de 1980.
- 23 % de la surface terrestre présente une productivité dégradée.

## Ce qui reste débattu

L'évaluation « Valeurs » de l'IPBES (2022) porte un regard critique sur la domination des
approches strictement marchandes dans la valorisation de la nature au sein des politiques
publiques ; ce constat relève d'une analyse et d'un plaidoyer scientifique, à distinguer des
données factuelles d'érosion de la biodiversité elles-mêmes, plus largement consensuelles.

[Emplacement image : illustration d'un écosystème riche (forêt, récif corallien ou zone
humide), légende et texte alternatif à fournir ultérieurement.]
...
---
type: article
title: Le stress hydrique mondial
slug: stress-hydrique-mondial
categoryPath: environnement-et-climat/pollution-et-ressources/eau
summary: >
  Selon les Nations unies, 2,2 milliards de personnes n'ont toujours pas accès à une eau
  potable gérée en toute sécurité, et environ la moitié de l'humanité connaît une pénurie
  d'eau sévère au moins une partie de l'année.
tags: [environnement, eau, stress-hydrique, UNESCO, ONU-Eau]
relatedArticles: []
sources:
  - title: "World Water Development Report 2024 - Statistics"
    url: "https://www.unesco.org/reports/wwdr/en/2024/s"
    publisher: "UNESCO / ONU-Eau"
    date: "2024"
lastVerified: 2026-09-21
status: published
---
...
Selon le Rapport mondial des Nations unies sur la mise en valeur de l'eau 2024, publié
conjointement par l'UNESCO et ONU-Eau, environ 2,2 milliards de personnes ne disposaient
toujours pas, en 2022, d'un accès à une eau potable gérée en toute sécurité, tandis que
3,5 milliards de personnes n'avaient pas accès à un assainissement géré en toute sécurité.
Ces chiffres illustrent l'ampleur persistante des inégalités mondiales d'accès aux ressources
en eau, plus de deux décennies après leur inscription parmi les priorités internationales de
développement.

## Une pénurie qui touche une large part de l'humanité

Le rapport estime qu'environ la moitié de la population mondiale connaît une pénurie d'eau
sévère au moins une partie de l'année, tandis qu'un quart de l'humanité fait face à un stress
hydrique qualifié d'« extrêmement élevé », c'est-à-dire une situation où plus de 80 % des
ressources en eau renouvelables disponibles sont déjà prélevées. Le niveau moyen mondial de
stress hydrique s'établissait à 18,6 % en 2021, une moyenne qui masque toutefois de très
fortes disparités régionales, certaines zones étant très largement au-dessus de ce niveau
moyen.

## L'agriculture, premier consommateur d'eau

La répartition des prélèvements d'eau douce dans le monde reste dominée par l'agriculture,
qui représente environ 70 % de la consommation totale, loin devant l'industrie (environ
20 %) et les usages domestiques (environ 12 %). Cette répartition explique pourquoi les
politiques de gestion durable de l'eau accordent une attention particulière à l'efficacité
de l'irrigation agricole, principal levier d'économie d'eau à l'échelle mondiale.

## L'impact croissant des sécheresses

Sur la période 2002-2021, plus de 1,4 milliard de personnes ont été affectées par des
épisodes de sécheresse à travers le monde, selon les données compilées dans le rapport. Ces
événements, dont la fréquence et l'intensité sont amenées à évoluer sous l'effet du
changement climatique, aggravent les tensions déjà existantes sur les ressources en eau
disponibles, en particulier dans les régions déjà soumises à un stress hydrique élevé.

## Faits clés

- 2,2 milliards de personnes sans accès à l'eau potable gérée en sécurité (données 2022).
- 3,5 milliards de personnes sans accès à un assainissement géré en sécurité.
- Environ la moitié de l'humanité connaît une pénurie d'eau sévère au moins une partie de
  l'année.
- L'agriculture représente environ 70 % des prélèvements mondiaux d'eau douce.

## À retenir

Le stress hydrique n'est pas uniquement une question de quantité d'eau disponible : la
qualité de l'eau, la répartition saisonnière des précipitations et les infrastructures de
distribution et d'assainissement jouent un rôle tout aussi déterminant dans l'accès effectif
des populations à une eau sûre.

[Emplacement image : carte mondiale du stress hydrique par région, légende et texte
